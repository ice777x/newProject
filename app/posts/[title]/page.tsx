...
export default async function Page({params}: any) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-[60px_auto] lg:grid-cols-[60px_65%_auto] p-4 gap-2 md:gap-4">
      <Reactions data={data} />
      <div className="bg-white mb-20 dark:bg-[#151F28] shadow-lg border-slate-300 overflow-hidden rounded-lg">
        <div>
          <img
      ...
      <div className="hidden lg:block min-h-screen">
        <div className="prose top-22 sticky dark:prose-p:text-slate-300 dark:prose-invert prose-img:my-0">
          <div className="rounded-lg bg-white dark:bg-[#1A2229] w-full shadow mb-8">
            <div className="p-4">
          ...
          <div className="rounded-lg prose-slate shadow prose-h2:mt-0 dark:prose-invert bg-white dark:bg-[#1A2229] w-full">
            <div className="p-4">
